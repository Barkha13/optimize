# print the home stadium of 10 random players in our database
players = Player.limit(10).order("RANDOM()")
players.each do |player|
  puts player.team.stadium
end

#using includes saves the associated tables in memory first to reduce database queries required to retrieve any information from those tables
